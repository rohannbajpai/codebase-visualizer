---
name: retro
description: Use when the user asks for `retro` or `/retro` in this repo. Follow the vendored gstack workflow at `.claude/skills/gstack/retro/SKILL.md`.
---
...
1. Read `.claude/skills/gstack/retro/SKILL.md` and use it as the source of truth.
...
3. Treat `/retro` as an alias for this Codex skill, not as a literal slash command.
