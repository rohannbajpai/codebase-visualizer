...
description: Use when the user asks for `plan-ceo-review` or `/plan-ceo-review` in this repo. Follow the vendored gstack workflow at `.claude/skills/gstack/plan-ceo-review/SKILL.md`.
---
...
1. Read `.claude/skills/gstack/plan-ceo-review/SKILL.md` and use it as the source of truth.
...
3. Treat `/plan-ceo-review` as an alias for this Codex skill, not as a literal slash command.
