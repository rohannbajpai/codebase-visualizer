...
description: Use when the user asks for `setup-browser-cookies` or `/setup-browser-cookies` in this repo. Follow the vendored gstack workflow at `.claude/skills/gstack/setup-browser-cookies/SKILL.md`.
---
...
1. Read `.claude/skills/gstack/setup-browser-cookies/SKILL.md` and use it as the source of truth.
...
3. Treat `/setup-browser-cookies` as an alias for this Codex skill, not as a literal slash command.
