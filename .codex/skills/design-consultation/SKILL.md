...
description: Use when the user asks for `design-consultation` or `/design-consultation` in this repo. Follow the vendored gstack workflow at `.claude/skills/gstack/design-consultation/SKILL.md`.
---
...
1. Read `.claude/skills/gstack/design-consultation/SKILL.md` and use it as the source of truth.
...
3. Treat `/design-consultation` as an alias for this Codex skill, not as a literal slash command.
