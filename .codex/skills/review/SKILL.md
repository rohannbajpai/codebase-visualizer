---
name: review
description: Use when the user asks for `review` or `/review` in this repo. Follow the vendored gstack workflow at `.claude/skills/gstack/review/SKILL.md`.
---
...
1. Read `.claude/skills/gstack/review/SKILL.md` and use it as the source of truth.
...
3. Treat `/review` as an alias for this Codex skill, not as a literal slash command.
