---
name: browse
description: Use when the user asks for `browse` or `/browse` in this repo. Follow the vendored gstack workflow at `.claude/skills/gstack/browse/SKILL.md`.
---
...
1. Read `.claude/skills/gstack/browse/SKILL.md` and use it as the source of truth.
...
3. Treat `/browse` as an alias for this Codex skill, not as a literal slash command.
