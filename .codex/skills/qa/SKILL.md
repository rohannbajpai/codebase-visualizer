---
name: qa
description: Use when the user asks for `qa` or `/qa` in this repo. Follow the vendored gstack workflow at `.claude/skills/gstack/qa/SKILL.md`.
---
...
1. Read `.claude/skills/gstack/qa/SKILL.md` and use it as the source of truth.
...
3. Treat `/qa` as an alias for this Codex skill, not as a literal slash command.
