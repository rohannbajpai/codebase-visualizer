---
name: gstack-upgrade
description: Use when the user asks for `gstack-upgrade` or `/gstack-upgrade` in this repo. Follow the vendored gstack workflow at `.claude/skills/gstack/gstack-upgrade/SKILL.md`.
---
...
1. Read `.claude/skills/gstack/gstack-upgrade/SKILL.md` and use it as the source of truth.
...
3. Treat `/gstack-upgrade` as an alias for this Codex skill, not as a literal slash command.
